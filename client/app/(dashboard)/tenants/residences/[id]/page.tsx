...
import { Property,Lease } from '@/types/prismaTypes';
import { CreditCard, Download, MapPin, User,Mail,Edit, FileText, Check, ArrowDownToLine } from 'lucide-react';
...
const ResidenceCard = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden p-6 flex-1 flex flex-col gap-6">
      {/* Header */}
      <div className="flex gap-5">
        <div className="w-64 h-32 bg-slate-500 rounded-xl" />
      ...
      <div className="flex justify-end gap-3 pt-4">
        <button className="bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center gap-2">
...
const PaymentMethod = () => {
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden p-6 mt-10 md:mt-0 flex-1">
      ...
      <p className="text-gray-600 mb-6">Change how you pay for your plan.</p>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex flex-col justify-between flex-1">
            <div className="flex items-center gap-4 mb-2">
              ...
              <span className="text-xs border border-slate-700 text-slate-700 px-3 py-1 rounded-full">
                Default
              </span>
            </div>
            <div className="text-sm text-gray-500 flex items-center mb-1">
              <CreditCard className="w-4 h-4 mr-1" />
              <span>Expiry 26/07/2026</span>
            </div>
          ...
          <TableBody>
            {payments.map((payment) => (
              <TableRow key={payment.id} className="h-16">
                ...
                <TableCell>
                  <button className="border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center gap-2">
...
const Residences = () => {
    ...
    if(!property || propertyError) return <div>Error Loading Residences property</div>
  ...
  <div className="dashboard-container">
    <div className="w-full mx-auto space-y-10">
      <div className="md:flex md:gap-10 flex-col lg:flex-row">
        {currentLease && (
      ...
      {/* Billing History - must be outside any icon/svg context */}
      <div>
